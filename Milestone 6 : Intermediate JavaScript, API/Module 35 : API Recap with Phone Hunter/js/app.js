...
const displayPhoneDetails = phone =>{
    ...
    phoneDetails.innerHTML = `
        ...
        <p>ChipSet: ${phone.mainFeatures.chipSet ? phone.mainFeatures.chipSet : 'ChipSet Not Found'}</p>
        <ul>Sensors: <li>${phone.mainFeatures.sensors ? phone.mainFeatures.sensors : 'Sensors Not Found'}</li></ul>
    `
}
